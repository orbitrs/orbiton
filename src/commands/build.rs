...
fn build_for_web(project_dir: &PathBuf, output_dir: &PathBuf, release: bool) -> Result<()> {
...
fn build_for_desktop(project_dir: &PathBuf, output_dir: &PathBuf, release: bool) -> Result<()> {
...
fn build_for_embedded(project_dir: &PathBuf, output_dir: &PathBuf, release: bool) -> Result<()> {
